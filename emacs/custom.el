...
(custom-set-faces
 ...
 '(diff-refine-added ((t (:inherit diff-refine-changed :background "#449944"))))
 '(diff-refine-removed ((t (:inherit diff-refine-changed :background "#885555"))))
 '(diff-removed ((t (:inherit diff-changed :extend t :background "#880000"))))
 ...
 '(flymake-error ((((class color)) (:background "red4"))))
 '(flymake-note ((t (:background "darkgoldenrod4"))))
 '(flymake-warning ((((class color)) (:background "darkorange3"))))
 ...
 '(git-diff-change ((t (:background "darkgoldenrod"))))
